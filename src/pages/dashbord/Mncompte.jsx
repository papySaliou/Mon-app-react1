...
export const Mncompte = () => {
  return (
    <div id="root" className='h-screen'>
      <div>
        <h1 className="text-4xl text-center text-sky-500">Rendez-vous</h1>
        <div className="flex items-center">
          <img src={user} className="bg-sky-500 p-2 ms-14 translate-x-8 rounded-full" width="120" alt="Float UI logo" />
          <h4 className="bg-sky-500 font-bold ps-11 text-2xl h-14 w-full flex items-center text-white">Mon Compte</h4>
        </div>
        ...
        <div className="flex justify-center">
          <button className="w-2/5 py-3 text-white duration-150 bg-sky-500 rounded-lg hover:bg-sky-900 active:shadow-lg">Enregistrer</button>
        </div>
      </div>
    </div>
  );
