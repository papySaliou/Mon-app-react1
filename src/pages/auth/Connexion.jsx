  ...
  return (
    <div className=" flex">
      ...
      <div className="flex flex-col justify-start items-center w-2/4">
        ...
        <input className="w-full p-5 m-4 bg-slate-50 py-3 rounded-xl" 
        type="text" placeholder="Adresse e-mail" />
        <input className="w-full p-5 m-4 bg-slate-50 py-3 rounded-xl"  
        type="password" placeholder="Mot de passe" />
        <Link to="/dashbord" className="w-full">
          <button className="bg-sky-600 text-white py-3 
          rounded-xl text-xl font-bold w-full">
            Se Connecter
          </button>
        </Link>
        <Link to="/dashbord" className="w-full">
          <button className="bg-black  my-3 flex items-center justify-center
           text-white py-3 rounded-xl text-xl font-bold w-full">
